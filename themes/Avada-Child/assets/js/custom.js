document.addEventListener("DOMContentLoaded", function () {
    ...
    var map = L.map('map').setView([34.023988, -84.306262], 17);

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; OpenStreetMap contributors'
    }).addTo(map);

    var marker = L.marker([34.023988, -84.306262]).addTo(map);

    marker.bindPopup(`
        <div class="custom-popup">
            1875 Old Alabama Rd., Ste. 910, Roswell, GA 30076
    ...
    map.on('popupopen', function () {
        var btn = document.querySelector('.custom-popup .close-btn');
        if (btn) {
